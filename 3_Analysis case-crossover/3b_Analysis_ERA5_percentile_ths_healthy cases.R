...
write.csv(results_all, "results/ApgarU7/ERA5_Tmean_pct_heatwave_healthy_cases.csv")
...
write.csv(results_all, "results/ApgarU7/ERA5_Tmax_pct_heatwave_healthy_cases.csv")
...
write.csv(results_all, "results/ApgarU7/ERA5_Tmin_pct_heatwave_healthy_cases.csv")
