...
load("data/PregnAnZI-2 trial/apgar_data_for_analysis_DBT_ERA5.RData")
data_pregnanzi2 <- apgar_temp
rm(list = setdiff(ls(), "data_pregnanzi2"))

load("data/PRECISE/apgar_data_for_analysis_DBT_ERA5.RData")
data_precise <- apgar_temp
rm(list = setdiff(ls(), c("data_pregnanzi2", "data_precise")))

load("data/Pregnanzi-1/apgar_data_for_analysis_DBT_ERA5.RData")
...
hw_vars <- paste0("HW", 1:30)   # adjust if your names differ
...
write.csv(results_all, "results/ApgarU7_excluding_stillbirth/ERA5_Tmean_pct_heatwave_excluding_stillbirth_with_Kenya.csv")
...
write.csv(results_all, "results/ApgarU7_excluding_stillbirth/ERA5_Tmax_pct_heatwave_excluding_stillbirth_with_Kenya.csv")
...
write.csv(results_all, "results/ApgarU7_excluding_stillbirth/ERA5_Tmin_pct_heatwave_excluding_stillbirth_with_Kenya.csv")

######################################################################## 
### DTR percentile thresholds
########################################################################

data <- data %>% 
  # 25th percentile
  mutate(HW1 = ifelse(dtr_pc25_lag0==1, 1, 0)) %>% 
  mutate(HW2 = ifelse(dtr_pc25_lag0==1 & dtr_pc25_lag1==1, 1, 0)) %>% 
  mutate(HW3 = ifelse(dtr_pc25_lag0==1 & dtr_pc25_lag1==1 & dtr_pc25_lag2==1, 1, 0)) %>% 
  mutate(HW4 = ifelse(dtr_pc25_lag0==1 & dtr_pc25_lag1==1 & dtr_pc25_lag2==1 & dtr_pc25_lag3==1, 1, 0)) %>% 
  mutate(HW5 = ifelse(dtr_pc25_lag0==1 & dtr_pc25_lag1==1 & dtr_pc25_lag2==1 & dtr_pc25_lag3==1 & dtr_pc25_lag4==1, 1, 0)) %>%  
  # 20th percentile
  mutate(HW6  = ifelse(dtr_pc20_lag0==1, 1, 0)) %>% 
  mutate(HW7  = ifelse(dtr_pc20_lag0==1 & dtr_pc20_lag1==1, 1, 0)) %>% 
  mutate(HW8  = ifelse(dtr_pc20_lag0==1 & dtr_pc20_lag1==1 & dtr_pc20_lag2==1, 1, 0)) %>% 
  mutate(HW9  = ifelse(dtr_pc20_lag0==1 & dtr_pc20_lag1==1 & dtr_pc20_lag2==1 & dtr_pc20_lag3==1, 1, 0)) %>% 
  mutate(HW10 = ifelse(dtr_pc20_lag0==1 & dtr_pc20_lag1==1 & dtr_pc20_lag2==1 & dtr_pc20_lag3==1 & dtr_pc20_lag4==1, 1, 0)) %>%  
  # 15th percentile
  mutate(HW11 = ifelse(dtr_pc15_lag0==1, 1, 0)) %>% 
  mutate(HW12 = ifelse(dtr_pc15_lag0==1 & dtr_pc15_lag1==1, 1, 0)) %>% 
  mutate(HW13 = ifelse(dtr_pc15_lag0==1 & dtr_pc15_lag1==1 & dtr_pc15_lag2==1, 1, 0)) %>% 
  mutate(HW14 = ifelse(dtr_pc15_lag0==1 & dtr_pc15_lag1==1 & dtr_pc15_lag2==1 & dtr_pc15_lag3==1, 1, 0)) %>% 
  mutate(HW15 = ifelse(dtr_pc15_lag0==1 & dtr_pc15_lag1==1 & dtr_pc15_lag2==1 & dtr_pc15_lag3==1 & dtr_pc15_lag4==1, 1, 0)) %>%  
  # 10th percentile
  mutate(HW16 = ifelse(dtr_pc10_lag0==1, 1, 0)) %>% 
  mutate(HW17 = ifelse(dtr_pc10_lag0==1 & dtr_pc10_lag1==1, 1, 0)) %>% 
  mutate(HW18 = ifelse(dtr_pc10_lag0==1 & dtr_pc10_lag1==1 & dtr_pc10_lag2==1, 1, 0)) %>% 
  mutate(HW19 = ifelse(dtr_pc10_lag0==1 & dtr_pc10_lag1==1 & dtr_pc10_lag2==1 & dtr_pc10_lag3==1, 1, 0)) %>% 
  mutate(HW20 = ifelse(dtr_pc10_lag0==1 & dtr_pc10_lag1==1 & dtr_pc10_lag2==1 & dtr_pc10_lag3==1 & dtr_pc10_lag4==1, 1, 0)) %>% 
  # 5th percentile
  mutate(HW21 = ifelse(dtr_pc5_lag0==1, 1, 0)) %>% 
  mutate(HW22 = ifelse(dtr_pc5_lag0==1 & dtr_pc5_lag1==1, 1, 0)) %>% 
  mutate(HW23 = ifelse(dtr_pc5_lag0==1 & dtr_pc5_lag1==1 & dtr_pc5_lag2==1, 1, 0)) %>% 
  mutate(HW24 = ifelse(dtr_pc5_lag0==1 & dtr_pc5_lag1==1 & dtr_pc5_lag2==1 & dtr_pc5_lag3==1, 1, 0)) %>% 
  mutate(HW25 = ifelse(dtr_pc5_lag0==1 & dtr_pc5_lag1==1 & dtr_pc5_lag2==1 & dtr_pc5_lag3==1 & dtr_pc5_lag4==1, 1, 0)) %>% 
  # 2nd percentile
  mutate(HW26 = ifelse(dtr_pc2_lag0==1, 1, 0)) %>% 
  mutate(HW27 = ifelse(dtr_pc2_lag0==1 & dtr_pc2_lag1==1, 1, 0)) %>% 
  mutate(HW28 = ifelse(dtr_pc2_lag0==1 & dtr_pc2_lag1==1 & dtr_pc2_lag2==1, 1, 0)) %>% 
  mutate(HW29 = ifelse(dtr_pc2_lag0==1 & dtr_pc2_lag1==1 & dtr_pc2_lag2==1 & dtr_pc2_lag3==1, 1, 0)) %>% 
  mutate(HW30 = ifelse(dtr_pc2_lag0==1 & dtr_pc2_lag1==1 & dtr_pc2_lag2==1 & dtr_pc2_lag3==1 & dtr_pc2_lag4==1, 1, 0))
...
results_all <- results_all %>%
  ...
  mutate(
    percentile = case_when(
      heatwave %in% c("HW1",  "HW2",  "HW3",  "HW4",  "HW5")  ~ "25th percentile",
      heatwave %in% c("HW6",  "HW7",  "HW8",  "HW9",  "HW10") ~ "20th percentile",
      heatwave %in% c("HW11", "HW12", "HW13", "HW14", "HW15") ~ "15th percentile",
      heatwave %in% c("HW16", "HW17", "HW18", "HW19", "HW20") ~ "10th percentile",
      heatwave %in% c("HW21", "HW22", "HW23", "HW24", "HW25") ~ "5th percentile",
      heatwave %in% c("HW26", "HW27", "HW28", "HW29", "HW30") ~ "2nd percentile",
      TRUE ~ NA_character_
    )
  )
...
plot_dat <- results_all %>%
  ...
  mutate(
    heatwave   = factor(heatwave, levels = c("HW1", "HW2", "HW3", "HW4", "HW5", "HW6", "HW7", "HW8", "HW9", "HW10", "HW11", "HW12", "HW13", "HW14", "HW15", "HW16", "HW17", "HW18", "HW19", "HW20", "HW21", "HW22", "HW23", "HW24", "HW25", "HW26", "HW27", "HW28", "HW29", "HW30")),
    duration   = factor(duration, levels = c("1 day", "2 days", "3 days", "4 days", "5 days")),
    percentile = factor(percentile,levels = c("25th percentile", "20th percentile", "15th percentile","10th percentile", "5th percentile", "2nd percentile")),
    sample     = factor(sample, levels = c("Full sample", "Burkina Faso", "Gambia", "Kenya", 
                                           "Urban", "Rural", 
                                           "Wet season", "Dry season", 
                                           "Daytime delivery",  "Nighttime delivery", 
...
plot_dat_limited <- plot_dat %>%
  ...
  filter(percentile!="2nd percentile")
...
write.csv(results_all, "results/ApgarU7_excluding_stillbirth/ERA5_DTR_pct_heatwave_excluding_stillbirth_with_Kenya.csv")
