...
load("data/mort_data_for_analysis.RData")
hist(mort_temp$tmean_lag0)

data <- mort_temp %>% 
  #generate mortality outcome
...
ggsave(
  filename = "figures/Results_mort_pct.png",        # File name for the image
